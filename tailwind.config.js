...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        accredited: "0.1875rem 0.1875rem 0.75rem 0rem rgba(0, 0, 207, 0.20)",
        news: "0.1875rem 0.1875rem 0.75rem 0rem rgba(0, 0, 207, 0.20)",
        childPage: "0.5625rem 0 1.25rem 0rem rgb(0 4 168 / 18%);",
        'inset-blue': 'inset 0.0625rem 0.0625rem 0.9375rem 0 rgba(142, 216, 248, 0.5)',
        'gold': '0.125rem 0.125rem 0.9375rem 0 rgba(249, 178, 0, 0.15)',
      },
      dropShadow: {
        "btn-slide": "0.125rem 0.125rem 0.625rem rgba(0, 0, 0, 0.05)",
        "gallery-item": "0.25rem 0.25rem 1.25rem 0rem rgba(0, 0, 0, 0.15)",
        partner: "0.25rem 0.25rem 0.9375rem 0rem rgba(0, 0, 0, 0.05)",
        'inset-blue': 'inset 0.0625rem 0.0625rem 0.9375rem 0 rgba(142, 216, 248, 0.5)',
        'gold': '0.125rem 0.125rem 0.9375rem 0 rgba(249, 178, 0, 0.15)',
